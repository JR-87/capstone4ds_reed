...
CPH relies on data that has a time to event component and covariates for
that event.
...
$H_0$: the predictor's coefficient does not vary with time

$H_1$: the predictor's coefficient does vary with time
