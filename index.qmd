...
plot(train$os2, martingale, main = "Martingale Residuals: os2")
abline(h = 0, col = "red")

plot(train$sm1, martingale, main = "Martingale Residuals: sm1")
abline(h = 0, col = "red")
...
plot(train$sm6, martingale, main = "Martingale Residuals: sm6")
abline(h = 0, col = "red")
...
plot(train$sm13, martingale, main = "Martingale Residuals: sm13")
abline(h = 0, col = "red")

plot(train$sm14, martingale, main = "Martingale Residuals: sm14")
abline(h = 0, col = "red")
