...
This assumption can be tested using the R package `survival`. The
package contains a proportional hazards test called `cox.zph()`
[@R-base]. Using the hypothesis,
...
this subject when modeling survival.
...
produce biased conclusions and violate the independence assumption.
